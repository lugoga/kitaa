...
1. [Quantitative Methods in R for Biology](https://figshare.com/articles/dataset/Portal_Project_Teaching_Database/1314459/10?file=10717177)

1. [Tidyverse Skills for Data Science](https://jhudatascience.org/tidyversecourse/wrangle-data.html)

1. [Modern R with the tidyverse](https://modern-rstats.eu/)
