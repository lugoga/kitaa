...
description: "Understanding the software and layout of the tools make it easy to access the right tools while interacting with the data and software"
...
```{r}
#| label: fig-rbase
#| fig-cap: The R program interface is a bit sparse compared to most Windows programs.
#| echo: false
#| out-width: "100%"

knitr::include_graphics("../screenshots/R-base.png")
```
...
```{r}
#| label: fig-rstudio
#| fig-cap: The RStudio program interface.
#| echo: false
#| out-width: "100%"

knitr::include_graphics("../screenshots/rstudio_gui.png")
```
