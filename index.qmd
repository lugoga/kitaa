...
<i class="fa-solid fa-envelope"></i>    [amina.kibola@nemc.or.tz]{style="color: #0069BF;"}

<i class="fa-brands fa-square-whatsapp"></i>   [+255 784 368 987]{style="color: #0069BF;"}
...
<i class="fa-brands fa-square-whatsapp"></i>   [+255 684 044 789]{style="color: #0069BF;"}
...
<i class="fa-solid fa-envelope"></i>    [elikananyikileo1@gmail.com ]{style="color: #0069BF;"}

<i class="fa-brands fa-square-whatsapp"></i>   [+255 756 048 083]{style="color: #0069BF;"}
...
Kaijage Laurian is an Ecological Data Manager at Mwambao Coastal Community Network, where he promotes data-driven decision-making and community engagement. He began his career as a research assistant at the University of Dar es Salaam, specializing in collecting DNA barcoding data for fish identification. With a background in R programming, Kaijage is skilled in utilizing data analytics tools and techniques. He is keen to explore the application of machine learning and artificial intelligence for ecological research and conservation.

<i class="fa-solid fa-envelope"></i>    [kaijagelaurian25@gmail.com]{style="color: #0069BF;"}

<i class="fa-brands fa-square-whatsapp"></i>   [+255 654 592 215]{style="color: #0069BF;"}
